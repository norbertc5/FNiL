...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        /// <summary>
        /// Event delegate triggered when pointer is over animationToPlay character.
        /// </summary>
        ...
        /// <summary>
        /// Event delegate triggered when pointer is over animationToPlay sprite.
        /// </summary>
        ...
        /// <summary>
        /// Event delegate triggered when pointer is over animationToPlay word.
        /// </summary>
        ...
        /// <summary>
        /// Event delegate triggered when pointer is over animationToPlay line.
        /// </summary>
        ...
        /// <summary>
        /// Event delegate triggered when pointer is over animationToPlay link.
        /// </summary>
        ...
        void Awake()
        {
            // Get animationToPlay reference to the text component.
            m_TextComponent = gameObject.GetComponent<TMP_Text>();

            // Get animationToPlay reference to the camera rendering the text taking into consideration the text component type.
        ...
        void LateUpdate()
        {
            if (TMP_TextUtilities.IsIntersectingRectTransform(m_TextComponent.rectTransform, Input.mousePosition, m_Camera))
            {
                ...
                if (charIndex != -1 && charIndex != m_lastCharIndex)
                {
                    ...
                    // Send event to any event listeners depending on whether it is animationToPlay character or sprite.
